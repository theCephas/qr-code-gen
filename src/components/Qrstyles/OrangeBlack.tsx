...
export default function OrangeBlack() {
    ...
    return (
        <Fragment>
                ...
                <section>
                    ...
                    <motion.div
                        className={`h-[100vh] font-bodyFont bg-[#e3e3e3]`}
                    >
                        <div
                            ref={qrRef}
                    ...
                    <footer className={`flex justify-between bg-[#e3e3e3] border-t border-t-black/20 duration-700 text-[10px] p-6 px-6 md:px-10`}>
                        <div className="flex">
