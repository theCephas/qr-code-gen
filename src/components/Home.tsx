                                ...
                                <main className="pt-20">
                                        <section className={`border-b border-b-white/30 pb-20`}>
                                                ...
                                                <motion.p
                                                        ...
                                                        className={`text-black/80 text-center duration-500 py-6 leading-8 px-6 md:px-10 md:w-[700px] m-auto text-[11px] ${isDarkMode ? 'dark:text-white/50' : 'light:bg'}`}>
                                        ...
                                        <motion.section
                                                ...
                                                <div className="flex flex-col md:flex-row justify-between items-center mt-12 mx-6 sm:mx-10">
                                                        ...
                                                        <img src="src\images\qrcodeill.png" className="w-[300px] sm:w-[400px] m-auto" alt="Qr Code illustration" />
                                                </div>
                                        </motion.section>
                                        ...
                                        animate={{ opacity: 1 }}
                                        transition={{ delay: 2, duration: 1.4 }}
                                        className={`${isDarkMode ? 'dark:bg-[#030d06]' : 'light:bg'} duration-700 pt-16 px-4 md:px-10 flex flex-wrap justify-center items-center`}>

                                                <div className={`border border-black/20 ${isDarkMode ? 'dark:border-white/30' : 'light:bg'} text-black cursor-pointer hover:bg-gradient-to-b from-emerald-600 to-green-800 rounded-2xl duration-700 p-10 mb-10 w-[275px] sm:w-[300px]`}>
                                                        ...
                                                        <p className={`pb-4 ${isDarkMode ? 'dark:text-white' : 'light:bg'} text-black text-[11px]`}>
                                                                <CheckBox size={18} className={`inline mr-2 text-green-500`} />
                                                                Quick business transactions
                                                        </p>
                                                        <p className={`${isDarkMode ? 'dark:text-white' : 'light:bg'} text-black text-[11px]`}>
                                                                <CheckBox size={18} className={`inline mr-2 text-green-500`} />
                                                                Enable easy payments
                                                        </p>
                                                        <p className={`pt-4 ${isDarkMode ? 'dark:text-white' : 'light:bg'} text-black text-[11px]`}>
                                                                <CheckBox size={18} className={`inline mr-2 text-green-500`} />
                                                                Boosts Business Efficiency
                                                        </p>

                                                </div>
                                                <div className={`border border-black/20 ${isDarkMode ? 'dark:border-white/30' : 'light:bg'} text-black hover:shadow-lg cursor-pointer hover:bg-gradient-to-b from-emerald-600 to-green-800 rounded-2xl duration-700 p-10 py-12 mb-10 w-[275px] sm:w-[300px]  sm:mx-8`}>
                                                ...
                                                <div className={`border border-black/20 ${isDarkMode ? 'dark:border-white/30' : 'light:bg'} text-black hover:shadow-lg cursor-pointer hover:bg-gradient-to-b from-emerald-600 to-green-800 rounded-2xl duration-700 p-10 py-12 mb-10 w-[275px] sm:w-[300px]`}>
                                                        <h4 className={`${isDarkMode ? 'dark:text-white' : 'light:bg'} text-black text-[16px] font-bold pb-4`}>For Families</h4>
                                                        <p className={`${isDarkMode ? 'dark:text-white/60' : 'light:bg'} text-black text-[11px] font-semibold text-black/40 pb-8`}>Keep loved ones informed effortlessly using the power of QR Codes. </p>
                                                        <p className={`pb-4 ${isDarkMode ? 'dark:text-white' : 'light:bg'} text-black text-[11px]`}>
                                                                <CheckBox size={18} className={`inline mr-2 text-green-500`} />
                                                                Event invitations
                                                        </p>
