...
export default function Qrcode() {
        ...
        return (
                <>
                        ...
                        <div
                                className={`font-bodyFont ${isDarkMode ? 'dark:bg-[#030d06]' : 'light:bg'} bg-white/40 `}
                        >
                                <div
                                        className={`text-center mx-4 pb-20 pt-20`}
                                >

                                        <h1 className={`pt-10 text-2xl font-bold md:text-4xl text-green-500`}>Create very nice and unique Qr Code</h1>
                                        <p className={`pt-6 text-black ${isDarkMode ? 'dark:text-white/60' : 'light:bg'} `}>Select any template of your choice</p>
                                        <Link to="/Basicqr">
                                                <motion.button
                                                        initial={{ x: '-100vw' }}
                                                        animate={{ x: 0 }}
                                        ...
                                        <div className="grid md:grid-cols-3 grid-cols-2 gap-10">
                                                <div>
                                                        ...
                                                        <Link to="/Qrcode">
                                                                <motion.button
                                                                        ...
                                                                        animate={{ x: 0 }}
                                                                        transition={{ delay: 1.4, type: 'spring', stiffness: 120 }}
                                                                        className={`bg-green-500 p-4 w-[200px] hover:bg-green-600 hover:duration-700 shadow-lg rounded-xl mt-4 flex justify-center m-auto`}
                                                                >Use</motion.button>
                                                        </Link>
                                                </div>
                                                ...
                                                <div>
                                                        ...
                                                        <motion.button
                                                                ...
                                                                animate={{ x: 0 }}
                                                                transition={{ delay: 1.4, type: 'spring', stiffness: 120 }}
                                                                className={`bg-green-300 cursor-not-allowed p-4 w-[200px] shadow-lg rounded-xl mt-4 flex justify-center m-auto`}
                                                ...
                                                <div>
                                                        ...
                                                        <motion.button
                                                                ...
                                                                animate={{ x: 0 }}
                                                                transition={{ delay: 1.4, type: 'spring', stiffness: 120 }}
                                                                className={`bg-green-300 p-4 w-[200px] cursor-not-allowed shadow-lg rounded-xl mt-4 flex justify-center m-auto`}
                                                        >Unavailable</motion.button>
